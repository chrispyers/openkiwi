...
function App() {
  ...
  const [agentForm, setAgentForm] = useState<{ name: string; avatar?: string; provider?: string; group?: string; heartbeat?: { enabled: boolean; schedule: string; allowManualTrigger?: boolean; }; maxLoops?: number }>({ name: '', provider: '', heartbeat: { enabled: false, schedule: '0 * * * *', allowManualTrigger: false } });
