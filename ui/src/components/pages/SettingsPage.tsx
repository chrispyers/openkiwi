...
interface SettingsPageProps {
    activeSettingsSection: 'about' | 'agents' | 'messaging' | 'tools';
    setActiveSettingsSection: (section: 'about' | 'agents' | 'messaging' | 'tools') => void;
    loading: boolean;
    ...
    return (
        ...
        >
            <nav className="flex gap-6 border-b border-border-color mb-10 overflow-x-auto whitespace-nowrap scrollbar-none pb-px">
                {['about', 'agents', 'messaging', 'tools'].map(id => (
                    <button
                        key={id}
